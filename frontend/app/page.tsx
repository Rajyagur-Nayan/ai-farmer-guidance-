...
export default function FarmerHome() {
    const { isListening, isSpeaking, transcribedText, error, startListening, stopListening } = useVoiceAgent();
    ...
    const features = [
        {
            ...
            description: "Speak directly with the AI in your native language for instant farming and technical support.",
            icon: Mic,
            route: "/voice",
        ...
        {
            title: "AI Chatbot 💬",
            description: "Chat with the intelligent assistant to troubleshoot crop issues or get tailored agricultural advice.",
            icon: MessageSquare,
            route: "/chat",
        ...
        },
        {
            ...
            description: "Upload photos of diseased crops, pests, or soil anomalies for instant high-fidelity diagnosis.",
            icon: Camera,
            route: "/diagnosis",
        ...
        },
        {
            ...
            description: "Access real-time Mandi rates and global commodity trends optimized for local agriculture.",
            icon: TrendingUp,
            route: "/market",
        ...
        {
            title: "Weather Info 🌦",
            description: "Sync with LIVE meteorological protocols to predict rainfall, temperature drops, and humidity.",
            icon: CloudRain,
            route: "/weather",
            ...
            <div className="space-y-16 pb-32 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <div className="relative z-10 space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-base text-white/80 max-w-xl leading-relaxed">
                                Your digital platform for agricultural intelligence, marketplace trading, and crop analysis.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="absolute top-8 right-8 z-20 max-w-sm w-full bg-white/10 backdrop-blur-2xl p-6 rounded-2xl border border-white/20 shadow-md animate-in zoom-in-95 duration-500">
                            {error ? (
                                ...
                                <p className="text-base text-white">
                                    <span className="text-sm font-semibold text-white/60 block mb-2">You said:</span>
                                    "{transcribedText}"
                                </p>
                            )}
                        </div>
                ...
                <div className="px-2">
                    <div className="flex items-center gap-6 mb-6 overflow-hidden">
                        <h2 className="text-xl font-semibold text-primary-900 whitespace-nowrap">Core Features</h2>
                        <div className="h-[2px] w-full bg-medical-border border-dashed"></div>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {features.map((feature, idx) => (
                            <div key={idx} className="animate-in fade-in zoom-in-95 fill-mode-both" style={{ animationDelay: `${idx * 50}ms`, animationDuration: '700ms' }}>
                                <FeatureCard {...feature} />
                            </div>
                        ))}
                    </div>
                ...
                <div className="text-center pt-20 border-t border-medical-border border-dashed">
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary-400">Agricultural Operating System V4.0 • Distributed Network</p>
                </div>
            </div>
        </Layout>
    );
